        ...
        <HeroStyled id="home">
            <section className={banner===false?"banner": "banner banner-active"} id="sec">
                ...
                <div className="content">
                    <h2>Hello World,<br/>I'm <span>Daniel Giraldo</span></h2>
                    <p>Electronig engineer from Universidad Industrial de Santander, passionate about software development and IoT</p>

        ...
        <AboutStyled id="about">
            <div className="about">
                <div className="me">
                    ...
                    <p className = "aboutme">
                    In my university studies I was interested in the area of the internet of things because it combines 2 interesting areas, which are software and hardware, my curiosity in software led me to learn web development. I have carried out my projects using frontend technologies such as react and complementing them with backend tools such as node.js and mongodb
                    </p>
                </div>
                <div className="likes">
